    ...
    public NavProvider()
    {
        ...
        SidebarGroups = new List<SidebarGroup>()
        {
            new SidebarGroup
            {
                ...
                {
                    new() { Title = "Introduction", Order = 1, Href = "/docs", Match = NavLinkMatch.All },
                    new() { Title = "Installation", Order = 2, Href = "/docs/installation" },
                    new() { Title = "Theming", Order = 3, Href = "/docs/usage" },
                    new() { Title = "Dark mode", Order = 4, Href = "/docs/dark-mode" },
                    new() { Title = "Typography", Order = 5, Href = "/docs/typography" },
            ...
            new SidebarGroup
            {
                ...
                Items = new List<SidebarItem>
                {
                    new() { Title = "Accordion", Order = 1, Href = "/docs/components/accordion", Matches = new List<string> { "/docs/components", "/docs/components/accordion" } },
                    new() { Title = "Alert", Order = 2, Href = "/docs/components/alert" },
                    new() { Title = "Alert Dialog", Order = 3, Href = "/docs/components/alert-dialog" },
                    new() { Title = "Aspect Ratio", Order = 4, Href = "/docs/components/aspect-ratio" },
                    new() { Title = "Avatar", Order = 5, Href = "/docs/components/avatar" },
                    new() { Title = "Badge", Order = 6, Href = "/docs/components/badge" },
                    new() { Title = "Breadcrumb", Order = 7, Href = "/docs/components/breadcrumb" },
                    new() { Title = "Button", Order = 8, Href = "/docs/components/button" },
                    new() { Title = "Calendar", Order = 9, Href = "/docs/components/calendar" },
                    new() { Title = "Card", Order = 10, Href = "/docs/components/card" },
                    ...
                    new() { Title = "Input", Order = 25, Href = "/docs/components/input" },
                    ...
                    new() { Title = "Tabs", Order = 45, Href = "/docs/components/tabs" },
