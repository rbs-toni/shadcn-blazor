...
public class CalendarDay
{
    ...
    readonly bool _isOutsideCurrentMonth;
    ...
    internal CalendarDay(Calendar calendar, DateTime day)
    {
        _calendar = calendar;
        Date = day;
    ...
    /// <summary>
    /// Gets a value indicating whether the day is selected by the user, using <see cref="Calendar.SelectMode"/>.
    /// </summary>
