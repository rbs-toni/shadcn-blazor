...
public enum TextFieldType
{
    ...
    /// <summary>
    /// A text field that is used for number input, if you don't want to use the <see cref="ShadcnBlazor.FluentNumberField{TValue}"/> component.
    /// </summary>
    Number,
}
